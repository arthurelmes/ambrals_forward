...
csv_out='/home/arthur/Dropbox/projects/ambrals_modeling/BRDF_LUT_principal_plane.csv'
...
# Set szen as constant here, gets updated for extreme lats later
