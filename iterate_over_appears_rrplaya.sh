...
csv_out='/home/arthur/Dropbox/projects/rr_valley/rr_valley_brdf.csv'

# I think to graph the principle plain, we need to iterate over vzen from -90 to +90
# every 1 degree, and hold szen and relaz constant for now
